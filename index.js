...
bot.onText(/\/start/, async (msg) => {
  ...
  activeFights.delete(chatId); walletState.delete(chatId);
...
bot.on('callback_query', async (query) => {
  ...
  if (data === 'back_to_main') {
    activeFights.delete(chatId); walletState.delete(chatId); const freshPlayer = await getOrCreatePlayer(chatId, query.from.username || 'Warbound');
