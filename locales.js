const locales = {
  ru: {
    ...
    btn_arena: "⚔️ Войти на Арену", btn_wastelands: "🏜️ Пустоши (Авто-фарм)", btn_wallet: "💎 Кошелек / TON Wallet", btn_lang: "🌍 Change Language / Сменить язык", btn_menu: "↩️ В Меню", btn_market: "🏛️ Торговая Площадь / Marketplace",
    btn_melee_cat: "⚔️ Ближний бой", btn_throw_cat: "💣 Метательное оружие",
    ...
    btn_claim: "🎒 Собрать добычу", btn_start_farm: "🚀 Запустить авто-фарм", btn_status: "📊 Статус фармера", farm_started: "🚀 *Экспедиция задеплоена!*", too_early: "⏳ Рано еще! Подожди минуту.",
    loot_report: (g, s, e) => "╔══════════════════════════════════════╗\n             🎒 LOOT REPORT            \n╚══════════════════════════════════════╝\nДобыча успешно доставлена на склад:\n\n┃ ⚜️ Золото: *+" + g + "*\n┃ ⚙️ Металлолом: *+" + s + "*\n" + (e ? "┃ ⚡ *НАХОДКА:* Редкое Энергетическое Ядро!\n" : "") + "──────────────────────────────────────\nДанные успешно сохранены в Supabase.",
    choose_weapon: "╔══════════════════════════════════╗\n            ⚔️ GEAR SELECTION         \n╚══════════════════════════════════╝\n\nВыбери класс вооружения для дуэли:",
    ...
    market_menu: (mg, pm) => "╔══════════════════════════════════════╗\n    ⚜️  M A R K E T P L A C E  ⚜️\n╚══════════════════════════════════════╝\n👤 NPC: Скупщик Трофеев Поталы\n🏛 Казна торговца: [ " + mg + " GOLD ]\n──────────────────────────────────────\n📦 ТВОЙ ИНВЕНТАРЬ:\n🎭 Маска Охотника: *" + pm + " шт.*\n\n_Цена скупки: 500 Gold за трофей._\n──────────────────────────────────────",
    btn_sell_mask: "💰 Продать Маску за 500 Gold", market_empty_merchant: "⚜️ *У торговца иссякли запасы золота!*", market_no_items: "❌ *У тебя нет Масок для продажи!*", market_success_sell: "✅ *Успешно!* Маска продана торговцу."
  },
  en: {
    welcome: (name, g, s, c, w, mp=100, st=100, d=4) => {
    ...
    btn_arena: "⚔️ Enter Arena", btn_wastelands: "🏜️ Wastelands (Auto-Farm)", btn_wallet: "💎 Wallet / TON Wallet", btn_lang: "🌍 Change Language / Сменить язык", btn_menu: "↩️ Menu", btn_market: "🏛️ Marketplace / " ,
    btn_melee_cat: "⚔️ Melee Weapons", btn_throw_cat: "💣 Throwing Weapons",
    choose_weapon: "╔══════════════════════════════════╗\n            ⚔️ GEAR SELECTION         \n╚══════════════════════════════════╝\n\nSelect your weaponry category for the Arena:",
