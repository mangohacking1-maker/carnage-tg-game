const WEAPON_BALANCING = {
  bow: { name_ru: "Лук Пенчак Силат [Яд]", name_en: "Bow (Pencak Silat) [Poison]", directDamage: 15, poisonDamage: 8, poisonDuration: 3 },
  claws: { name_ru: "Когти Вин Чун [Урон]", name_en: "Claws (Wing Chun) [Damage]", directDamage: 30, critChance: 0.35, critMultiplier: 1.5 }
};
